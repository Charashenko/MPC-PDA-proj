...
class Robot(QGraphicsItemGroup):
    ...
    def init_state(self):
        ...
        self.__base.pixmap = QPixmap(os.getcwd() + "/robocode/robotImages/baseGrey.png")
        ...
        self.__gun.pixmap = QPixmap(os.getcwd() + "/robocode/robotImages/gunGrey.png")
        ...
        self.__radar.pixmap = QPixmap(os.getcwd() + "/robocode/robotImages/radar.png")
