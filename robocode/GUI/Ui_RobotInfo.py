...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        icon = QIcon()
        icon.addPixmap(QPixmap("robocode/robotImages/small.png"), QIcon.Normal, QIcon.Off)
        icon.addPixmap(QPixmap("robocode/robotImages/small.png"), QIcon.Disabled, QIcon.Off)
        ...
        icon1 = QIcon()
        icon1.addPixmap(QPixmap("robocode/robotImages/smallRed.png"), QIcon.Normal, QIcon.Off)
        icon1.addPixmap(QPixmap("robocode/robotImages/smallRed.png"), QIcon.Disabled, QIcon.Off)
